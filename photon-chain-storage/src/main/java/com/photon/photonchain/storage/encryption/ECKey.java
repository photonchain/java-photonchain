 ...
 * This file is part of the PhotonJ library.
 *
 * The PhotonJ library is free software: you can redistribute it and/or modify
 * it under the terms of the GNU Lesser General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * The PhotonJ library is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
 * GNU Lesser General Public License for more details.
 *
 * You should have received a copy of the GNU Lesser General Public License
 * along with the PhotonJ library. If not, see <http://www.gnu.org/licenses/>.
 */
...
import com.photon.photonchain.storage.encryption.eccrypto.*;
import com.photon.photonchain.storage.utils.ByteUtil;
...
import static com.photon.photonchain.storage.utils.ByteUtil.bigIntegerToBytes;
 ...
 *
 * This code is borrowed from the bitcoinj project and altered to fit Photon.<br>
...
public class ECKey implements Serializable {
    ...
    /**
     * The parameters of the secp256k1 curve that Photon uses.
     */
    ...
    private static final long serialVersionUID = 1604274249031586830L;

    static {
        // All clients must agree on the curve to use by agreement. Photon uses secp256k1.
     ...
     * how ECDSA signatures are represented when embedded in other data structures in the Photon protocol. The raw
    ...
    public static class ECDSASignature {
         ...
         * the same message. However, we dislike the ability to modify the bits of a Photon transaction after it's
     ...
     * @param signatureBase64 The Photon-format message signature in base64
     *
     * @return -
    ...
    public static String  pubkeyToAddress(String pubkey){
        String address = "";
        try {
            address = Constants.ADDRESS_PREFIX + Hex.toHexString(ECKey.computeAddress(Hex.decode(pubkey)));
        }catch (Exception e){
            logger.info("pubkeyToAddress exception");
            e.printStackTrace();
        }
        return address;
    }
